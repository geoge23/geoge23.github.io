...
WADaily is a website that solves a surprisingly difficult problem: What schedule is it today? Our school makes use of a complicated revolving schedule, meaning the order
...
Schedule information is stored in MongoDB due to its unstructured nature, and an internal tool allows for the addition of schedule information by members of the maintenance team. 

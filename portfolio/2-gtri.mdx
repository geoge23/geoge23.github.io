...
mimics the system found in react-router. It allows creation of routes and navigation between these routes, as well as query parameters to be attached when travelling to new routes. I also implemented a global state store similar to Redux
